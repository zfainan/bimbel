        ...
        <div class="card-body">
            <form action="{{ route('siswa.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="date" value="{{ old('tgl_lahir') }}" name="tgl_lahir" class="form-control @error('tgl_lahir') is-invalid @enderror"
                            required>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ old('no_telp') }}" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror"
                            required>
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="">Nama Ortu<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <input type="text" value="{{ old('nama_ortu') }}" name="nama_ortu" class="form-control @error('nama_ortu') is-invalid @enderror"
                            required>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{ old('kelas') }}" name="kelas" class="form-control @error('kelas') is-invalid @enderror"
                            required>
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="">Status<span
                            class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <input type="text" value="{{ old('status') }}" name="status" class="form-control @error('status') is-invalid @enderror"
                            required>
